...
module timing (
    ...
    output logic cpu_addr_strobe_o,    // 1-cycle pulse indicating the start of a valid CPU address
    output logic cpu_data_strobe_o,    // 1-cycle pulse indicating CPU din/dout is valid
    ...
    localparam bit [COUNTER_WIDTH-1:0] CPU_BE_START     = CPU_1 * 8,
                                       CPU_ADDR_STROBE  = CPU_BE_START + ns_to_cycles(CPU_tBVD) - 1,
                                       CPU_PHI_START    = CPU_ADDR_STROBE + ns_to_cycles(IOTX_t),
